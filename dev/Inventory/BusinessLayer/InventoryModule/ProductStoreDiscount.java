...
public class ProductStoreDiscount {
    ...
    public List<ProductStoreDiscount> addDiscountStore(List<ProductStoreDiscount> discountStoreList, LocalDateTime startDate, LocalDateTime endDate){
        if(isDateInRange(startDate,endDate))
            discountStoreList.add(this);
        return discountStoreList;
    }
