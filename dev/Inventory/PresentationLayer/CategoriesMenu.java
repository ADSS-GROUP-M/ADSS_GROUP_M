...
public class CategoriesMenu extends MainMenu {
    ...
    private void mainCategory() {
        ...
        System.out.println(inventoryService.createMainCatagory(category_name).getReturnValue());
    }

    private void subCategory() {
        System.out.println("Please enter new category's name");
        String category_name = in.nextLine();
        System.out.println(inventoryService.createSubCatagory(category_name).getReturnValue());
    }

    private void removeMainCategory() {
        System.out.println("category name:");
        String category_name = in.nextLine();
        System.out.println(inventoryService.removeMainCatagory(category_name).getReturnValue());
    }

    private void removeSubCategory() {
        System.out.println("category name:");
        String category_name = in.nextLine();
        System.out.println(inventoryService.removeSubCatagory(category_name).getReturnValue());
    }
}
