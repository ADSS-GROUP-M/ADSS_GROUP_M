...
public class Tests {
    ...
    public void setUp() throws Exception {
        ...
        empService.loadData();
        if(userService.getUser(username2).getReturnValue()==null)
    ...
    public void recruit_newEmployee() {
        try {
            Response<Boolean> ans = empService.recruitEmployee(admin.getUsername(),"Max T","1", "555","Hapoalim 12 231", 50, LocalDate.of(2023,2,2),"Employment Conditions Test", "about me");
            assertTrue(ans.getErrorMessage() == null);
