...
class ShiftToRequestsDAO {
    private static ShiftToRequestsDAO instance;
    private ShiftToRequestsDAO(){

    }
    static ShiftToRequestsDAO getInstance() {
       if(instance == null)
          instance = new ShiftToRequestsDAO();
       return instance;
    }

    Map<Role, List<Employee>> getAll(LocalDate dt, Shift.ShiftType st, String branch) throws Exception {
        return null;
    }
