package Tests.dev.BusinessLayer.Employees;
...
public class UserTest {
    ...
    public void login_correctPassword() {
        try {
            ...
            Assert.fail("Test failed, did not expect an exception when logging in with a correct password.");
        }
    }
    ...
    public void logout_beforeLoggingIn() {
        try {
            user.logout();
            Assert.fail("Test failed, expected an exception when logging out before logging in.");
        } catch (Exception ignore) { }
    }
    ...
    public void logout_afterLoggingIn() {
        try {
            ...
            Assert.fail("Test failed, did not expect an exception when logging out after logging in successfully.");
        }
    }
