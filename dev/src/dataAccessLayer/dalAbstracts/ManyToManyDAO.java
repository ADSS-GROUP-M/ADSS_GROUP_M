...
//    }
//
//    protected ManyToManyDAO(SQLExecutor cursor, String tableName){
...
//            createTableQueryBuilder.addCompositeForeignKey( PARENT_TABLE_NAME[i],FOREIGN_KEYS[i], REFERENCES[i]);
//        }
//
