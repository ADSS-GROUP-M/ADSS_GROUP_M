...
public class ProductItemDataMapper extends AbstractDataMapper {
    ...
    public void insert(String serial_number, int is_defective, String defection_date, String supplier_id, double supplier_price, double supplier_discount, double sold_price, LocalDateTime expiration_date, String location, String catalog_number, String branch) throws DalException{
    ...
    public void update(String serial_number, int is_defective, LocalDateTime defection_date, String supplier_id, double supplier_price, double supplier_discount, double sold_price, LocalDateTime expiration_date, String location, String catalog_number, String branch) throws DalException{
        try{
    ...
    public void delete(String serial_number, String catalog_number, String branch) throws DalException{
        if (isExists(serial_number, catalog_number, branch)) {
            try {
    ...
    public Map<String, List<ProductItem>> initializeCache() throws DalException{
        try {
...
//                    item.setIntIsDefective(resultSet.getInt("is_defective"), formatter));
    ...
    public boolean isExists(String catalog_number, String serial_number, String branch) throws DalException{
        try {
