...
public class ProductsDiscountsDataMapper extends AbstractDataMapper {
    ...
    public void insert(String bnNumber, String catalogNumber, int amount, Discount discount) throws DalException {
    ...
    public void delete(String bnNumber, String catalogNumber, int amount) throws DalException {
        try {
    ...
    public Map<String, Map<Integer, Discount>> find(String bnNumber) throws DalException {
        try {
            String columnsString = String.join(", ", columns);
