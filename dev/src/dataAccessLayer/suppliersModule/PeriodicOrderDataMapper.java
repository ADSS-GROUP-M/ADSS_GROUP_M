...
public class PeriodicOrderDataMapper extends AbstractDataMapper {
    ...
    private void insert(int orderId, String catalogNumber, int quantity) throws DalException {
    ...
    public void insert(String bnNumber, Order order, int day, Branch branch) throws DalException {
        try {
            int orderId;
    ...
    public PeriodicOrder getPeriodicOrder(int orderId) throws DalException {
    ...
    public Map<Integer, PeriodicOrder> getAllPeriodicOrders() throws DalException {
        try {
            int maxOrderId;
            OfflineResultSet resultSet = sqlExecutor.executeRead(String.format("SELECT MAX(order_id) as max_id FROM %s", periodicOrderDetailsDataMapper.getTableName()));
    ...
    public int findDay(String catalogNumber, Branch branch) throws DalException {
        try {
