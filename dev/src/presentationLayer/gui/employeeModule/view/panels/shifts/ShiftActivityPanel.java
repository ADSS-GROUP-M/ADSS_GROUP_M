...
public class ShiftActivityPanel extends AbstractTransportModulePanel {
    ...
    public ShiftActivityPanel(ShiftsControl control, EmployeeView employeeView) {
        super(control);
    ...
    private void showConfirmationDialog(SShift shift) {
        String activity = JOptionPane.showInputDialog(newOpenPanel, "Please insert the shift activity to report:", "Confirmation", JOptionPane.YES_NO_OPTION);
        if (activity != null) {
            String result = ((ShiftsControl) control).reportShiftActivity(shift, activity);
            if (result != null) {
    ...
    private void openNewWindow(Object dayShifts) {
        ...
        if (dayShifts instanceof SShift[] shifts){
            ...
            JButton cancelCardButton = new JButton("Report shift activity");
            cancelCardButton.setPreferredSize(new Dimension(250, 30));
            ...
            newOpenPanel.add(cancelCardButton);
        ...
        newOpenWindow.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowEvent) {
                ...
                employeeView.setCurrentPanel(new ShiftActivityPanel((ShiftsControl) control, employeeView));
