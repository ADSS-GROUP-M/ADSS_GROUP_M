...
public class ShiftActivityPanel extends AbstractModulePanel {
    ...
    private void showConfirmationDialog(SShift shift) {
        ...
        if (activity != null) {
            String result = ((ShiftsControl) control).reportShiftActivity(employeeId, (String)branchIdComboBox.getSelectedItem(), shift, activity);
            if (result != null) {
    ...
    private void openNewWindow(Object dayShifts) {
        ...
        if (dayShifts instanceof SShift[] shifts){
            ...
            PrettyButton reportActivityButton = new PrettyButton("Report shift activity");
