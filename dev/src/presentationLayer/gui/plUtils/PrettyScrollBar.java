...
public class PrettyScrollBar extends JScrollBar {
    ...
    public PrettyScrollBar(int thumbSize) {
        setUI(new PrettyScrollBarUI(thumbSize));
        setPreferredSize(new Dimension(8, 8));
        setForeground(new Color(48, 144, 216));
        setBackground(Color.WHITE);
    }

    private static class PrettyScrollBarUI extends BasicScrollBarUI {

        private final int THUMB_SIZE;

        public PrettyScrollBarUI(int thumbSize) {
            super();
