...
class DriversDAOTest {
    ...
    @BeforeEach
    void setUp() {
        employee = new Employee("name1","12345",50,"Poalim", LocalDate.of(1999,10,10),"conditions","details");
    ...
    void selectAll() {
        ...
        List.of(2,3,4,5,6).forEach(i ->{
            try {
                empDao.create(new Employee("name"+i,i+"2345",50,"Poalim", LocalDate.of(1999,10,10),"conditions","details"));
    ...
    @Test
    void insert() {
        Employee employee2 = new Employee("name2","22345",50,"Poalim", LocalDate.of(1999,10,10),"conditions","details");
